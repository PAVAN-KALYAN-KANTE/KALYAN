...
class account{
   ...
   void deposit(ll money){
      ...
      // vp2.push_back(make_pair(acc_num,"credit"));
       vp1.push_back({acc_num,"credit",money});
       vp2.push_back(vp1);
   ...
   void withdraw(ll money){
      ...
      // vp2.push_back(make_pair(acc_num,"debit"));
       vp1.push_back({acc_num,"debit",money});
       vp2.push_back(vp1);
   ...
   void view_statement(){
       cout<<"DATE"<<"\t\t"<<"ACC_NUM"<<"\t\t"<<"NAME"<<"\t"<<"    CR/DR"<<"\t"<<"AMOUNT"<<"\t"<<endl;
      for (auto i = 0; i < vp2.size(); ++i) {
       // cout << "(" << vp2.at(i]).first << ","
      //      << vp2.at(i).second << ")" << "; ";
       cout<<__DATE__<<"\t "<<acc_num<<"\t\t"<<name<<"\t   "<<vp1.at(i).b<<"\t"<<vp1.at(i).c<<"\t"<<endl;
   ...
   while(1){
       ...
       int x;
        ...
        switch(x){
            ...
            case 2:
            ll k,m;
            cout<<"ENTER ACC_NUM AND MONEY "<<endl;
            cin>>acc_num;
            cin>>k;
